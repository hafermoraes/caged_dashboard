...
def qry_base_table(input_dt_inicial, input_dt_final, input_ocupacao):
    ...
    qry_string = f"""           
          ...
          left join origemdainformacao  as orig on c.origemdainformacao  = orig.codigo
              where cbo.descricao = '{input_ocupacao}'
                and c.competenciamov >= '{input_dt_inicial}'
                and c.competenciamov <= '{input_dt_final}'
                  ;
    """
    return qry_string
